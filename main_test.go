...
func metadata(timestamp string) string {
	return `{"photoTakenTime":{"timestamp":"` + timestamp + `"}}`
}
...
func TestOriginalFile(t *testing.T) {
	...
	writeFile(t, filepath.Join(inputDir, "photo.jpg"+metadataSuffix), metadata("1108563029"))
...
func TestEditedSuffix(t *testing.T) {
	...
	writeFile(t, filepath.Join(inputDir, "photo.jpg"+metadataSuffix), metadata("1500677462"))
...
func TestDirectoryStructurePreserved(t *testing.T) {
	...
	writeFile(t, filepath.Join(sub, "photo.jpg"+metadataSuffix), metadata("1108563029"))
...
func TestMissingMediaFileSkipped(t *testing.T) {
	...
	writeFile(t, filepath.Join(inputDir, "ghost.jpg"+metadataSuffix), metadata("1108563029"))
